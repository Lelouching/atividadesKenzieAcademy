async function pegaImagens() {
  ...
  const imgTags = document.querySelectorAll("img[data-src]") // Pegando todas imagens com o atributo data-src

  async function adicionaIntersectionAsImagens() {
    await renderizaImagens() // Utilizamos um await para aguardar a criação das tags antes de adicionarmos o observador
